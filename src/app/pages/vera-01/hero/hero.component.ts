...
import { AfterViewInit, Component, DOCUMENT, ElementRef, inject, Inject, PLATFORM_ID, Renderer2, ViewChild } from '@angular/core';
...
export class HeroComponent implements AfterViewInit {
   ...
   private async typewriter(): Promise<void> {
      ...
      this.renderer.setAttribute(cursor, 'class', 'cursor-blink ml-1 text-veraBronze');
